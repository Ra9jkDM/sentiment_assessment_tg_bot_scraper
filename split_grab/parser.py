...
class OtzovikParser:
    def __init__(self, session, base_link, links, save_review, save_index, start_index = 0, delay = 5):
    ...
    def _get_page(self, url):
        ...
        # check for capcha [save func from other class (Captha_manager) in this class]
...
if __name__ == '__main__':
    ...
    p = OtzovikParser(session, base_link, links, save_review, save_index)
    p.start()
