...
def plazmaRec(pix, x1, y1, x2, y2):
  ...
  print(x1, (y1 + y2)/2, int((y1 + y2)/2), pix, rgb[0], rgb[5], rgb[10])

  pix[int(x1), int((y1 + y2)/2)] = (int(rgb[0]), int(rgb[5]), int(rgb[10]))
  pix[x2, int((y1 + y2)/2)]= (int(rgb[1]), int(rgb[6]), int(rgb[11]))
  pix[int((x1 + x2)/2), y1] = (int(rgb[2]), int(rgb[7]), int(rgb[12]))
  pix[int((x1 + x2)/2), y2] = (int(rgb[3]), int(rgb[8]), int(rgb[13]))  
  pix[int((x1 + x2)/2), int((y1 + y2)/2)] = (int(rgb[4]), int(rgb[9]), int(rgb[14]))
